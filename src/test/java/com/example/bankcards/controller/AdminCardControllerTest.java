...
class AdminCardControllerTest {
    ...
    void testBlockingCard() throws Exception {
        mvc.perform(patch("/admin/cards/blocking")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testBlockingCardByRequest() throws Exception {
        mvc.perform(patch("/admin/cards/blocking/byRequest")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(UUID.randomUUID()))
                        .characterEncoding(StandardCharsets.UTF_8))
                .andExpect(status().isAccepted());
    ...
    void testActivateCard() throws Exception {
        mvc.perform(patch("/admin/cards/activate")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(UUID.randomUUID())))
                .andExpect(status().isAccepted());
    ...
    void testDeleteCard() throws Exception {
        mvc.perform(delete("/admin/cards")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(UUID.randomUUID()))
                        .characterEncoding(StandardCharsets.UTF_8))
    ...
    void testGetAllCards() throws Exception {
        ...
        mvc.perform(get("/admin/cards/all")
                        .accept(MediaType.APPLICATION_JSON)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .param("page", "0")
                        .param("size", "10"))
